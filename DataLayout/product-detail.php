            ...
            <div class="col-lg-10 col-md-12 col-lg-offset-1">
              <div class="ps-product__thumbnail">
                <div class="ps-product__preview">
                  <div class="ps-product__variants">
                    <div class="item"><img src="../publics/images/shoe-detail/1.jpg" alt=""></div>
                    <div class="item"><img src="../publics/images/shoe-detail/2.jpg" alt=""></div>
                    <div class="item"><img src="../publics/images/shoe-detail/3.jpg" alt=""></div>
                    <div class="item"><img src="../publics/images/shoe-detail/3.jpg" alt=""></div>
                    <div class="item"><img src="../publics/images/shoe-detail/3.jpg" alt=""></div>
                ...
                <div class="ps-product__image">
                  <div class="item"><img class="zoom" src="../publics/images/shoe-detail/1.jpg" alt="" data-zoom-image="../publics/images/shoe-detail/1.jpg"></div>
                  <div class="item"><img class="zoom" src="../publics/images/shoe-detail/2.jpg" alt="" data-zoom-image="../publics/images/shoe-detail/2.jpg"></div>
                  <div class="item"><img class="zoom" src="../publics/images/shoe-detail/3.jpg" alt="" data-zoom-image="../publics/images/shoe-detail/3.jpg"></div>
                </div>
              </div>
              ...
              <div class="tab-content mb-60">
                ...
                <div class="tab-pane" role="tabpanel" id="tab_02">
                  ...
                  <div class="ps-review">
                    <div class="ps-review__thumbnail"><img src="../publics/images/user/1.jpg" alt=""></div>
              ...
              <div class="ps-shoes--carousel">
                <div class="ps-shoe">
                  <div class="ps-shoe__thumbnail">
                    <div class="ps-badge"><span>New</span></div><a class="ps-shoe__favorite" href="#"><i class="ps-icon-heart"></i></a><img src="../publics/images/shoe/1.jpg" alt=""><a class="ps-shoe__overlay" href="product-detail.html"></a>
                  </div>
